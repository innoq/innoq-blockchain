...
exports.register = (blockchain, sse, req, res) => {
  ...
  fetch(host)
    ...
    .then(fetchedNode => {
      ...
      stream.addEventListener('new_transaction', (event) => {
        console.log(`node ${host} sends a new transactions: `, event.data)
